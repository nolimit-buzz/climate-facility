        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center">
            ...
            <motion.div 
              ...
              className="h-1.5 bg-primary mb-8"
            />
            ...
            >
              <h4 className="text-sm font-bold tracking-[0.2em] text-gray-400 uppercase mb-6">Who We Are</h4>
              
              <h2 className="text-4xl lg:text-5xl font-bold text-secondary mb-8 leading-tight">
                Mobilising blended finance for <span className="text-primary">sustainable energy</span> access.
              </h2>
              ...
              <button className="group flex items-center gap-3 text-secondary font-bold text-lg hover:text-primary transition-colors">
                Read more about our mission
                <span className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center group-hover:bg-primary group-hover:border-primary group-hover:text-white transition-all">
                    <ArrowRight size={18} />
                </span>
              </button>
            </motion.div>
            ...
            >
               ...
               <div className="flex flex-wrap gap-x-8 gap-y-6 items-center opacity-80 hover:opacity-100 transition-opacity">
                  ...
                  {/* UK Aid */}
                 <img src="/ukaid-logo.png" alt="UK Aid" width={100} height={100} className="h-8 w-auto" />

                  {/* InfraCredit */}
                  <img src="/infracredit-logo.svg" alt="InfraCredit" width={100} height={100} className="h-8 w-auto" />

                  {/* AIICO */}
                  <img src="/aiico-logo.png" alt="AIICO" width={100} height={100} className="h-8 w-auto" />

                   {/* Linkage */}
                  <img src="/linkage-logo.png" alt="Linkage" width={100} height={100} className="h-8 w-auto" />
